...
@section('content')
    ...
    <h3 class="bold">Guidelines</h3>
<br>

<p class="bold" class="line">Paper and Poster Submission Guidelines</p>
...
<li>Each author, as the primary author, can submit up to two different submissions of paper and/or
   posters.</li>
<li>Primary authors must be investigators who are currently affiliated with academic institutions, or are
  doctoral level professionals (PhD, MD, EdD) in other institutions, or are graduate students and other
  professionals with doctoral level mentors.</li>
<li>Empirical research should be completed or well under way rather than at the beginning stages. It must
  include analyses and a summary of findings. Stating &quot;the data will be analyzed&quot; or &quot;findings
  will be presented/discussed&quot; is not sufficient for either the poster or paper presentation.</li>
...
<li>The study must have followed the standards of ethics in research with human beings and obtained
  appropriate ethical approval if it is an empirical study.</li>
<li>The Scientific Advisory Council of the Institute of Coaching will review all paper and poster submissions
...
<p>All those invited to submit a poster will be entered into the Best Poster competition. The Scientific
...
<p class="bold">The first author of the two Honorable Mention awards will receive a one-year complementary Affiliate
  Membership in the IOC.</p>
